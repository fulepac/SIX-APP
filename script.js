...
function toggleMaster() {
    ...
    document.getElementById("masterTools").style.display = isChecked ? "block" : "none";
}
...
function updateUI(r) {
    ...
    document.getElementById("statusBanner").innerText = (r.game && r.game.started) ? "PARTITA IN CORSO" : "SERVER PRONTO";
}
